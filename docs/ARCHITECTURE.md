...
║  │ (wacli/QR) │  │  Instagram   │  │  Marketplaces │  │   (solo Alex)    │ ║
║  │  directa   │  │  CTWA ads    │  │  anuncios     │  │                  │ ║
║  └──────┬──────┘  └──────┬───────┘  └───────┬───────┘  └────────┬─────────┘ ║
║         │                │                   │                    │           ║
║         ▼                ▼                   ▼                    ▼           ║
║  ╔══════════════════════════════════════════════════════════════════════════╗ ║
...
║  ║  │CPL/CTR/Rpt  │ │Listings refresh  │ │ Validación compliance         │  ║ ║
║  ║  │NO capt.leads│ │NO capt.leads     │ │ Solo canal interno            │  ║ ║
║  ║  └──────────────┘ └──────────────────┘ └──────────────────────────────┘  ║ ║
║  ║                                                                           ║ ║
║  ╚══════════════════════════════════════════════════════════════════════════╝ ║
║                │                                                              ║
...
```
Lead envía mensaje → WhatsApp (wacli/QR)
       ↓
